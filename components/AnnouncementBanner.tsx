...
export default function AnnouncementBanner() {
  ...
  if (pathname === "/dortmund-ki-studie-2026") return null;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span>
          <span className="font-semibold">85% der Dortmunder Restaurants unsichtbar für KI.</span>{" "}
          Studie lesen
        </span>
        <span
